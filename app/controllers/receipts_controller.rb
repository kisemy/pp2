class ReceiptsController < ApplicationController
  ...
  private
    ...
    def receipt_params
      params.require(:receipt).permit(:receipt_date, :bank_code, :description, :received_by, :receipt_by, :receipt_mode, :receipt_description, :status, :document_no, :amount, :received_from, :account_type, :accountno)
    end
end
